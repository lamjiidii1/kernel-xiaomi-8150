...
KERNEL_NAME=Sapphire-cepheus-"$DATE"
...
git clone --depth=1 /run/media/lamjiidii1/Building/PA/prebuilts/clang/host/linux-x86/clang-proton $CLANG_PATH
...
echo "=========================Build========================="
make J4 O=out CC="ccache clang" CXX="ccache clang++" CROSS_COMPILE=$CLANG_PATH/bin/aarch64-linux-gnu- CROSS_COMPILE_ARM32=$CLANG_PATH/bin/arm-linux-gnueabi- LD=ld.lld cepheus_defconfig
make J4 O=out CC="ccache clang" CXX="ccache clang++" CROSS_COMPILE=$CLANG_PATH/bin/aarch64-linux-gnu- CROSS_COMPILE_ARM32=$CLANG_PATH/bin/arm-linux-gnueabi- LD=ld.lld 2>&1 | tee out/kernel.log
